	...
	public class Graphmodel extends EventDispatcher
	{
		...
		public function getRelType(uri:String, label:String):RelType {
			...
			for each(var r:RelType in relTypes) {
				...
				//ExternalInterface.call('console.log', "r.id======");/////xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx	
		...
		public function getRelation(subject:Element, predicate:Element, object:Element):Relation {
			...
			// var relId:String = subject.id + predicate.id + object.id;///////xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
			
			var relId:String = predicate.id;
			
			

			// ExternalInterface.call('console.log', "subject.id====="+subject.id);
			// ExternalInterface.call('console.log', "predicate.id==="+predicate.id);
			// ExternalInterface.call('console.log', "object.id======"+object.id);
			// ExternalInterface.call('console.log', "relId=========="+relId);
		...
		private function addRelationToGraph(subjectNode:MyNode, predicateNode:MyNode, objectNode:MyNode, layout:Object = null):void {
			...
			// ExternalInterface.call('console.log', "subjectNode.id======"+subjectNode.id);/////xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
			// ExternalInterface.call('console.log', "predicateNode.id===="+predicateNode.id);/////xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
			// ExternalInterface.call('console.log', "objectNode.id======="+objectNode.id);/////xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
			
			var object1:Object = new Object();
			object1.startId = subjectNode.id;	//defines the direction of the link!
			
			// ExternalInterface.call('console.log', "subjectNode.id======"+subjectNode.id);/////xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
			// ExternalInterface.call('console.log', "object1.startId====="+object1.startId);/////xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
			...
			// ExternalInterface.call('console.log', "predicateNode.id===="+predicateNode.id);/////xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
			// ExternalInterface.call('console.log', "object2.startId====="+object2.startId);/////xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
		...
		public function drawPath(p:Path, immediatly:Boolean = false):void {
			...
			if (delayedDrawing && !immediatly) {
				...
				// ExternalInterface.call('console.log', "_toDrawPaths==="+_toDrawPaths.toArray);
				
				_toDrawPaths.enqueue(p);
				
				// ExternalInterface.call('console.log', "_toDrawPaths==="+_toDrawPaths.size);
				
				startDrawing();
				
				ExternalInterface.call('console.log', "effective1");
				
				// ExternalInterface.call('console.log', "r.subject======"+r.subject);/////xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
				// ExternalInterface.call('console.log', "r.predicate===="+r.predicate);
				// ExternalInterface.call('console.log', "r.object======="+r.object);
						
				ExternalInterface.call('console.log', "p.relations===="+p.relations);
				
			}else {
				for each(var r:Relation in p.relations) {
					drawRelation(r, p.layout);
					
					ExternalInterface.call('console.log', "effective2");
				}
			}
		...
		private function drawRelation(r:Relation, layout:Object = null):void {
			...
			// ExternalInterface.call('console.log', "subject========`"+subject);/////xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
			// ExternalInterface.call('console.log', "predicate======"+predicate);
			// ExternalInterface.call('console.log', "object========="+object);
			
			// ExternalInterface.call('console.log', "r.subject======"+r.subject);/////xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
			// ExternalInterface.call('console.log', "r.predicate===="+r.predicate);
			// ExternalInterface.call('console.log', "r.object======="+r.object);
			// ExternalInterface.call('console.log', "r.id==========="+r.id);
		...
		public function startDrawing():void {
			...
			if (!_timer.running) {
				...
				ExternalInterface.call('console.log', "effective6");
		...
		private function drawNextPath(event:Event):void {
			if (_toDrawPaths.isEmpty()) {
				...
				ExternalInterface.call('console.log', "effective3");
				...
				if (!p.isVisible) {	//if it is not visible, try the next one
					...
					ExternalInterface.call('console.log', "effective4");
				}else {
					for each(var r:Relation in p.relations) {
						drawRelation(r, p.layout);
						
						ExternalInterface.call('console.log', "effective5");
