		...
		public function set isVisible(b:Boolean):void {
			if (_isVisible != b) {
				...
				if (_isVisible) {
					...
					ExternalInterface.call('console.log', "this.pathLength==="+this.pathLength.num);///////////////////////////////////////////////////////////////
					ExternalInterface.call('console.log', "this.relations===="+this.relations);///////////////////////////////////////////////////////////////
		...
		public function set isHighlighted(b:Boolean):void {
			...
			if (b != _isHighlighted) {
				...
				if (_isHighlighted) {
					...
					// ExternalInterface.call('console.log', "this==="+this.relations);///////////////////////////////////////////////////////////////////////////////////////////////////////
