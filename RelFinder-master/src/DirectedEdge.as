...
package 
{
	...
	public class DirectedEdge implements IEdgeRenderer
	{
		...
		public function draw(g:Graphics, fromView:UIComponent, toView:UIComponent, fromX:int, fromY:int, toX:int, toY:int, graph:Graph): Boolean {
			...
			//ExternalInterface.call('console.log', "fromView====="+(fromView as IDataRenderer).data); 
			// ExternalInterface.call('console.log', "fromView====="+fromView); 
			//ExternalInterface.call('console.log', (toView as IDataRenderer).data); 
			// ExternalInterface.call('console.log', toView.x); 
			
			
			var fromItem:Item = (fromView as IDataRenderer).data as Item;
			var toItem: Item = (toView as IDataRenderer).data as Item;
			
			// ExternalInterface.call('console.log', "from====="+fromItem); 
			...
			// ExternalInterface.call('console.log', "from====="+linkData); 
			...
			if (linkData != null) {
				...
				// ExternalInterface.call('console.log', "aaaaaaaaaa"); 
				...
				if (linkData.hasOwnProperty("startId")) {
						...
						// ExternalInterface.call('console.log', "bbbbb"); 
				
				
						// ExternalInterface.call('console.log', "start===="+linkData.startId);
						// ExternalInterface.call('console.log', "---");
						// ExternalInterface.call('console.log', "from====="+fromItem.id);  
						// ExternalInterface.call('console.log', "---");
						// ExternalInterface.call('console.log', "to======="+toItem.id);
						// ExternalInterface.call('console.log', "---");
					...
					if(linkData.startId != fromItem.id) {	//falschrum!! alles umdrehen
						...
						// ExternalInterface.call('console.log', "kkkkkkkkkkkkkkkkkkkkkkkkkk");
						// ExternalInterface.call('console.log', "---");
						// ExternalInterface.call('console.log', "from====="+fromItem.id);
