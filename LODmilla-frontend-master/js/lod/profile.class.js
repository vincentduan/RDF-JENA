...
var Profile = new function() {
    ...
    this.searchURLs = {
        ...
        '本地数据库': 'http://192.168.0.102:3030/ds?query='
            + encodeURIComponent("PREFIX crm: <http://dbpedia.org/resource/>\n"
                + "PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>\n"
                + 'SELECT DISTINCT ?object ?label { ?object rdfs:label ?label . FILTER(REGEX(?label, "MPAD_SEARCH_TERM")) } LIMIT '+ this.addNewResourceSearchMaxHits.toString() )
